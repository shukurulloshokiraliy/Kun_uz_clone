...
const Header = () => {
  ...
  return (
    <header>
      ...
      <nav className="sticky top-0 z-9000 bg-white border-b border-gray-200 rounded-lg container shadow-sm">
        <div className="px-6 h-16">
          <div className="flex items-center justify-between h-full">
            ...
            <nav className="hidden lg:flex items-center space-x-9">
              ...
              <NavLink to="/Likes" className="flex gap-2 items-center text-gray-900 hover:text-blue-600 font-semibold text-base transition-colors">
          ...
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <div className="mx-auto px-6 py-4" style={{ maxWidth: '1370px' }}>
              <div className="flex flex-col space-y-1">
                ...
                <NavLink 
                  to="/Likes" 
                  className="text-gray-900 hover:text-blue-600 hover:bg-gray-50 font-semibold text-base py-3 px-2 rounded transition-colors flex items-center gap-2"
                >
                  <img src={bookmark} alt="Bookmark" className="h-6" />
                  <span>Saralanganlar</span>
                </NavLink>
